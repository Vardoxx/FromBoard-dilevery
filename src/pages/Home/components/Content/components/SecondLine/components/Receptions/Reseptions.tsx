      ...
      <div className={s.icons_container}>
        ...
        <div>
          ...
          <div>
            ...
            специалистами c особым вниманием к деталям, гарантируя, что они
        ...
        <div>
          ...
          <div>
            ...
            максимально удобным для вас, чтобы опыт остался приятным и
            беззаботным
          </div>
        </div>
        ...
        <div>
          ...
          <div>
            <span>Прозрачность работы </span>Мы предоставляем полный контроль
            над каждым этапом доставки, от момента заказа до момента прибытия
            заказа
          </div>
        </div>
